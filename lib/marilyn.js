	...
	var _modelSet = function(modelName, init) {
		...
		Model.createSilent = function(element, callback) {
			...
			element.del = function() {
				_resultDelete.call(element);
			};

			element.delSilent = function() {
				_resultDeleteSilent.call(element);
			};
		...
		Model.readSilent = function(query, callback) {
			...
			_.each(results, function(result) {
				...
				result.del = function() {
					_resultDelete.call(result);
				};

				result.delSilent = function() {
					_resultDeleteSilent.call(result);
				};
